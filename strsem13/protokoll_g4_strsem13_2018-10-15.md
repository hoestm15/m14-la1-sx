...
Einheitliche Schnittstellen: Hauptunterscheidungsmerkmal von anderen Architekturstilen.   
Besteht aus weitern 3 Eigenschaften:  
              ...
              * Repräsentaition zur Veränderung von Ressourcen: Enn REST-Server kann in verschiedenen Sprachen oder Formaten(HTML, JSON oder XML)   einer Ressource ausliefern.  
