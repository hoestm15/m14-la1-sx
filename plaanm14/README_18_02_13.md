...
| Register | Objekttyp | Zugriff |
|:-----------------:|:---------:|:-------:|
| Register Eingang | "Discrete Input" | kann nur gelesen werde |
| Register Eingang | "Input Register" | kann nur gelesen werden |
| Register Ein und Ausgang | "Coil" | kann gelesen und geschreiben werden |
| Register Ein und Ausgang | "Holding Register" | kann gelesen und geschreiben werden |
