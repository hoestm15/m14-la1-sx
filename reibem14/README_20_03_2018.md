...
private void showThrowable (Throwable th)
  ...
  ```  
  ### connect()     
  Wie schon der Name sagt, verbindet diese Funktion unser Sure Board mit dem PC. Dabei werden auch wichtige Einstellungen wie Baudrate, Datenbits, Parity und Stopbits getroffen.
  ```java  
