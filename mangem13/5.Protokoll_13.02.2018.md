...
## Inhaltsangabe:
    1. Besprechung der letzten Protokolle
    2. 
    3.
    4. 
    
## Modbus
Um von einem Sure-Board Daten an einen PC zu übertragen wird ein entsprechendes Feldbusprotokoll benötigt. In _Fivu_ haben wir bereits einige besprochen, aber Varianten wie Powerlink(B&R), Profinet(PROFIBUS) oder Flexray
(div. Automobil- und Elektronikunternehmen) fallen aufgrund von fehlenden Lizenzen für unsere Zwecke flach.  
Jedoch können wir den Modbus verwenden, den dieser ist ein offener und freier Modbus.  
