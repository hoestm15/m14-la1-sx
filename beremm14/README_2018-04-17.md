...
| Parameter | Beschreibung |
| --------- | ------------ |
| [Baudrate](https://de.wikipedia.org/wiki/Symbolrate) | Die Baudrate gibt die Anzahl der übertragenen "Symbole" an. Bei einem [Leitungscode](https://de.wikipedia.org/wiki/Leitungscode) ist ein Symbol oft größer als ein Bit, somit ist die Bitrate höher als die Symbolrate. |
