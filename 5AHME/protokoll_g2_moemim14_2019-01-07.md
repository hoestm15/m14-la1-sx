...
Wir haben ein Projekt mit dem **Node Package Manager** erstellt. Der Befehl für die Konsole lautet: `npm init`. Mit diesem Befehl werden Pakete loakl installiert. Dafür wird die Datei `package.json` verwendet, welche mit `npm init` erzeugt wurde.
